<template>
  <div id="app">
    <div class="eg-slideshow">
      ...
      <slide leave="fadeOut">
        <h1 class="solitary-headline">2. The Solution</h1>
      </slide>
      ...
      <slide leave="fadeOut">
        <h1 class="solitary-headline">3. The Real Solution</h1>
      </slide>
      <slide leave="fadeOut">
        <h1 class="solitary-headline">Don't improve the handoff – abandon it</h1>
      </slide>
